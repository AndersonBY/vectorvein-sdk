...
class SunoMusicGeneration(Node):
    def __init__(self, id: str | None = None):
        super().__init__(
            node_type="SunoMusicGeneration",
            category="audioGeneration",
            task_name="audio_generation.suno_music_generation",
            node_id=id,
            ports={
                "prompt": InputPort(
                    name="prompt",
                ...
                "output": OutputPort(),
                "metadata": OutputPort(name="metadata"),
            },
        )
