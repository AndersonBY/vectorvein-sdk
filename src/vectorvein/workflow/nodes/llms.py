            ...
            ports={
                ...
                "llm_model": InputPort(
                    ...
                    options=[
                        ...
                        {"value": "glm-4.7-flash-thinking", "label": "glm-4.7-flash-thinking"},
    ...
    def __init__(self, id: str | None = None):
        super().__init__(
            ...
            ports={
                ...
                "output": OutputPort(),
                "reasoning_content": OutputPort(name="reasoning_content"),
                "function_call_output": OutputPort(
                    name="function_call_output",
                    condition="return fieldsData.use_function_call.value",
                    condition_python=lambda ports: ports["use_function_call"].value,
            ...
            ports={
                ...
                "llm_model": InputPort(
                    ...
                    options=[
                        ...
                        {"value": "MiniMax-M2.1-lightning", "label": "MiniMax-M2.1-lightning"},
...
class UniversalLlm(Node):
    def __init__(self, id: str | None = None):
        super().__init__(
            node_type="UniversalLlm",
            category="llms",
